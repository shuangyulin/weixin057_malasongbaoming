  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.bisairiqi" label="比赛日期" prop="bisairiqi">
              <el-input v-model="ruleForm.bisairiqi" 
                placeholder="比赛日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="比赛要求" prop="bisaiyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="比赛要求"
                  v-model="ruleForm.bisaiyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bisaiyaoqiu" label="比赛要求" prop="bisaiyaoqiu">
                    <span>{{ruleForm.bisaiyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.bisaineirong = this.ruleForm.bisaineirong.replace(reg,'../../../ssmu4knd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
