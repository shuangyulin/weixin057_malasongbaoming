<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<button :style='{"boxShadow":"0 0 0px rgba(0,0,0,0) inset","backgroundColor":"rgba(244, 67, 54, 1)","borderColor":"rgba(57, 78, 99, 1)","borderRadius":"8rpx","color":"#fff","borderWidth":"0","width":"60%","fontSize":"28rpx","borderStyle":"solid","height":"76rpx"}' v-if="isAuth('users','新增')" class="add-btn" @click="onAddTap()">新增</button>
